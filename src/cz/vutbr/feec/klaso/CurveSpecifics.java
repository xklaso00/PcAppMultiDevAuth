...
public class CurveSpecifics {
    static ECParameterSpec ecSpec224 = ECNamedCurveTable.getParameterSpec("secp224r1");
    static ECCurve curve224 = ecSpec224.getCurve();
    static ECParameterSpec ecSpec256 = ECNamedCurveTable.getParameterSpec("secp256k1");
    static ECCurve curve256=ecSpec256.getCurve();
    ...
    static ECParameterSpec ecSpec160 = ECNamedCurveTable.getParameterSpec("secp160r1");
    static ECCurve curve160=ecSpec160.getCurve();
